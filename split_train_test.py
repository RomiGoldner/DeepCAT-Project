def split_train_test(healthy_path="TrainingData/healthy_samples_cut.txt", sick_path="TrainingData/brca_samples_pbmc.txt"):
    ...
    # Save to files
    with open("TrainingData/healthy_samples_cut_train.txt", "w") as f:
        for line in healthy_train:
            f.write(line + "\n")
    with open("TrainingData/healthy_samples_cut_test.txt", "w") as f:
